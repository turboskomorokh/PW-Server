...
public static class PositionConversions
{
    ...
    {
        return new(
            x * ConfigData.TileSizeX,
            y * ConfigData.TileSizeY - ConfigData.TileSizeY * 0.5f
        );
    }
    ...
    {
        return new Vector2i(
            (int)((x + ConfigData.TileSizeX * 0.5f) / ConfigData.TileSizeX),
            (int)((y + ConfigData.TileSizeY * 0.5f) / ConfigData.TileSizeY)
        );
    }
