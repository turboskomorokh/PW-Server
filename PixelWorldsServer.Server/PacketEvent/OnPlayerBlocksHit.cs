...
[PacketHandler(NetStrings.HIT_BLOCK_KEY)]
public class OnPlayerHitBlock : IPacketHandler
{
...
[PacketHandler(NetStrings.HIT_BLOCK_BACKGROUND_KEY)]
public class OnPlayerHitBlockBackground : IPacketHandler
{
    public Task Invoke(EventContext context, BsonDocument document)
    {
        HitBlockRequest request = BsonSerializer.Deserialize<HitBlockRequest>(document);
