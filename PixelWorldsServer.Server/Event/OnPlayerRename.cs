...
public class OnPlayerRename : IEvent
{
  ...
  public async Task Invoke(EventContext context, BsonDocument document)
  {
    ...
    RenamePlayerRequest request = BsonSerializer.Deserialize<RenamePlayerRequest>(document);
    Console.WriteLine("[EH] Triggered OnRenamePlayer");
